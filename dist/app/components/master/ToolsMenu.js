...
import { X, Megaphone, DollarSign, Folder, Factory, Trophy, GraduationCap, Layers, BarChart3, Users, Ticket, Globe2, MessageCircle, Paintbrush } from 'lucide-react';
...
import SiteOrdersTool from './SiteOrdersTool.js';
import SiteManagerTool from './SiteManagerTool.js';
const TOOLS = [
    ...
    { key: 'siteManager', icon: Paintbrush, label: 'Gerenciar Site', desc: 'Layout, banners, produtos, cores e conteúdo do e-commerce', component: SiteManagerTool },
    { key: 'siteOrders', icon: Globe2, label: 'Pedidos Site', desc: 'Pedidos recebidos em suplementaai.com.br', component: SiteOrdersTool },
